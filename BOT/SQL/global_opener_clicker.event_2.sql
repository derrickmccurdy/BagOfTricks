...
-- 	declare all the variables we will need
	...
	declare app_done2 int default 0 ;
...
-- 			end repeat get_data_loop
-- 			}
			until 1 = done_leased end repeat get_data_loop ;
			close cur1 ;



			get_abandoned_data_loop : repeat 
-- 			{
...
-- 			}
			until 1 = done_abandoned  
			end repeat get_abandoned_data_loop ;
			close cur3 ;
